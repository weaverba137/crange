...
fcomplex Complex( double re, double im ); /* Return complex given real and imaginary parts */
fcomplex Conjg( fcomplex z );             /* Complex conjugation */
fcomplex Csqrt( fcomplex z );             /* Square root of a complex number */
fcomplex RCmul( double x, fcomplex a );   /* Multiply complex and real numbers */
...
double Carg( fcomplex z );                /* Arguement of a complex number (in radians) */
